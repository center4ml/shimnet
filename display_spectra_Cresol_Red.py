...
def run(input_file, corrected_file1, corrected_file2, reference_file):

    # ======= WCZYTANIE DANYCH =======
    input_spectrum_file = os.getenv("INPUT_SPECTRUM_FILE", input_file)
    corrected_spectrum_file1 = os.getenv("CORRECTED_SPECTRUM_FILE1", corrected_file)
    corrected_spectrum_file2 = os.getenv("CORRECTED_SPECTRUM_FILE2", corrected_file)
    ...
    freqs_corr, spec_corr1 = load_spectrum(corrected_spectrum_file1)
    freqs_corr, spec_corr2 = load_spectrum(corrected_spectrum_file2)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--corrected1", type=str, required=False)
    parser.add_argument("--corrected2", type=str, required=False)
